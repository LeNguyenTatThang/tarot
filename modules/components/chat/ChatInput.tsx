        ...
        <>
            <form className="flex flex-col gap-2 px-4 border-t border-neutral-300 py-4 dark:border-neutral-700">
                {replyName && (
                    ...
                    >
                        <span className="dark:text-neutral-100">{t("widget.replying_to")} {replyName}</span>
                        <CloseIcon
                            size={14}
                ...
                <div className="flex">
                    <input
                        ...
                        ref={inputRef}
                        autoFocus
                        className="grow rounded-md border p-2 focus:outline-none dark:border-neutral-600"
                    />
                    <button
                        type="submit"
