...
const ChatWidgetHeader = () => {
    ...
    return (
        <div className="relative flex items-center justify-between border-b p-4 dark:border-neutral-600">
            <div className="flex items-center gap-2">
                <Tooltip title={t("tooltip_title")} position="bottom">
                    <ChatRoomIcon
                        size={22}
                        onClick={handleClick}
                ...
                <p className="font-medium dark:text-neutral-100">{t("title")}</p>
            </div>
